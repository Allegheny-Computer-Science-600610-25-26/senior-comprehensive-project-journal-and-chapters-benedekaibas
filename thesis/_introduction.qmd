...
implementations against each other and against the actual Python runtime behavior, Pytifex identifies discrepancies that indicate potential
bugs in type checkersi.
