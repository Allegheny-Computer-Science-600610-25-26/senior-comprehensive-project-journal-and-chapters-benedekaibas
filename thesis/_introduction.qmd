...
definitively prove false negatives (missed bugs), but cannot prove false positives (spurious errors) in all cases since code may run
successfully without triggering every potential bug path.
