...
The code in ~\ref{fig:fig-false-mypy} passes type checking in mypy without warnings, yet crashes at runtime with an AttributeError—the `itertools` module has no
