...
```{python}
#| label: fig-false-mypy
#| fig-cap: False negative in mypy
#| fig-scap: False negative in mypy
#| lst-label: lst-false-mypy
import itertools
...
The code in @fig-false-mypy passes type checking in mypy without warnings, yet crashes at runtime with an AttributeError—the `itertools` module has no
...
5. **Open-source release of Pytifex and our generated test suite** at
   [https://github.com/benedekaibas/pytifex], enabling reproduction and future research on type checker validation.
